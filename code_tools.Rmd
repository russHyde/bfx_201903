...
- Improve the effiency of the user and your collaborators (ie, _future you_)
...
This has a Makefile for: linting, testing, installation and doc creation.
...
## Made a new sphinx-ready package
